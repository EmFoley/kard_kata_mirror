...
# 				{answer: "hören", question:	"to hear, listen", deck_id: 1},
...
# 				{answer: "öffnen", question:	"to open", deck_id: 1},
...
cards = [{"answer" => "test", "question" => "test", "deck_id" => 1},
{"answer" => "test", "question" => "test", "deck_id" => 1}]
